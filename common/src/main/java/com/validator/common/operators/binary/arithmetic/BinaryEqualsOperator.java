...
/**
 * Binary Equals Operator Object. It is an arithmetic operator and thus
 ...
 */
@XmlRootElement
public class BinaryEqualsOperator<T> implements BinaryArithmeticOperator<T> {
	...
	public boolean operate(T t1, T t2) {
		...
		try {
			ValidationHelper.validateValue(t1).against(t2).usingValidator(ValidationHelper.isEqual());
